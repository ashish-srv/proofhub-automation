...
CLIENT_NAME_MAPPING = {
    ...
    'AMC_Aquapharm Specialty & Aquapharm India': 'Aquapharm India',
    'AMC_Avet Pharmacuticals': 'Avet Pharmacuticals',
    'AMC_Blog SIIB': 'SIIB',
    'AMC_Europa Locks': 'Europa Locks',
    'AMC_IITB Monash': 'IITB Monash',
    ...
    'AMC_SCIT Blog': 'SCIT',
    'AMC_SCMHRD': 'SCMHRD',
    'AMC_SCMS Hyd': 'SCMS Hyderabad',
    'AMC_SCMS Hyd Blog': 'SCMS Hyderabad',
    'AMC_SCMS_NOIDA': 'SCMS Noida',
    'AMC_SIBM Nagpur': 'SIBM Nagpur',
    'AMC_SIBM Noida': 'SIBM Noida',
    'AMC_SIBM Pune': 'SIBM Pune',
    'AMC_SIBM Pune Blog': 'SIBM Pune',
    'AMC_SIBM hyd': 'SIBM Hyderabad',
    'AMC_SIIB website': 'SIIB',
    'AMC_SIT Hyd': 'SIT Hyderabad',
    'AMC_SIT Nagpur': 'SIT Nagpur',
    'AMC_SIU Dubai': 'SIU Dubai',
    'AMC_SRV': 'SRV',
    'AMC_SRV MEdia Blog': 'SRV',
    'AMC_Scalasar_Slspune': 'SLS Pune',
    'AMC_Set': 'SET',
    'AMC_Snap': 'SNAP',
    'AMC_Symbi School': 'Symbiosis School',
    'AMC_Symlaw (SLS PUNE)': 'SLS Pune',
    'AMC_Thermax': 'Thermax',
    'AMC_Winsoft Tech': 'Winsoft Tech',
    'BLOG_SCMHRD_AMC': 'SCMHRD',
    'Kennametal (WIDMA)': 'Kennametal',
    'LP_Kennametal': 'Kennametal',
    'LP_MITWPU_AMC': 'MIT-WPU',
    'LP_NITTE': 'Nitte',
    'LP_QMUL_AMC': 'QMUL',
    'LP_Vivekanand Business School': 'Vivekanand Business School',
    'SCMS 2026': 'SCMS',
    'SCMS Global Programme': 'SCMS',
    'SCOP 2025': 'SCOP',
    'SCRI Pune 2025': 'SCRI',
    'SSBF (MBA Executive)': 'SSBF',
    'SSBF 2025': 'SSBF',
